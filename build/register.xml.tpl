...
<package name="kubernetes" version="{{PLUGIN_VERSION}}">
    ...
    <systemParameters>
        ...
        <systemParameter name="KUBERNETES_S3_ACCESS_KEY" scopeType="plugins" defaultValue="access_key" />
        <systemParameter name="KUBERNETES_S3_SECRET_KEY" scopeType="plugins" defaultValue="secret_key" />
    </systemParameters>
